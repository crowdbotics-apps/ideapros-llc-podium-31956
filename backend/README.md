...
## Project Structure
    ...
    ├── ideapros_llc_podium_31956  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_podium_31956`
...
2. Clone this repo and `cd ideapros_llc_podium_31956`
